...
const HeroSection: React.FC = () => {
  return (
    <section className="flex flex-col px-5 pt-5 pb-3.5 mt-32 w-full font-bold text-center text-pink-900 min-h-[315px] max-md:mt-10 max-md:max-w-full">
      ...
      <Link to={'/teststart'} className="flex gap-6 justify-center items-center self-center px-5 py-2.5 mt-9 max-w-full text-lg font-semibold text-white capitalize bg-pink-900 rounded-3xl min-h-[50px] w-[300px]">
